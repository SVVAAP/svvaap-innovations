    ...
    <div className="relative  py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative overflow-hidden rounded-lg shadow-lg">
          <div className="flex items-center h-[400px] bg-gray-900">
            {/* Left Section */}
            <div className="w-1/3 p-8 flex flex-col justify-center space-y-4 bg-gradient-to-r from-gray-900 to-transparent text-white">
            ...
            <div className="w-2/3 relative">
              <iframe
                ...
                className="absolute inset-0 w-full h-full border-0 rounded-lg shadow-xl"
              />
